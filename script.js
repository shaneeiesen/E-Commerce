...
for (let i = 0; i < products.length; i++) {
  ...
  for (let x = 0; x < product.tags.length; x++) {
    ...
    let tag = product.tags[x];



    if (product.category == "groceries" && product.tags[x] === "fruits" || product.tags[x] === "vegetables") {
...
//       let viewProductHtml = `<div class="viewProductDiv">

//         <div class="dec-img">
//             <img src="${product.images}"
//                 alt="">
//         </div>
//         <div class="details-cart" style="padding-left: 2rem;">
//                 <h1>${product.title}</h1>
...
//                 <div>
//                 <h2>DISCLAIMER</h2>
//                 <p>It's fresher for longer: Our unbroken cold chain means your fruit stay fresh for longer, even after you take them home
//                 Only the best is good enough: Expect only the best varieties grown in superb locations to deliver the best quality and flavour
//                 Our farmers are quality: Before we pick our fruit, we pick our farmers. They're as obsessed with quality as we are
...
//     </div>
//         <div>
//             <button class="dec-btn" id="btn-decclose">Close</button>
//         </div>`;
//         viewProductDialog1.innerHTML += viewProductHtml;
